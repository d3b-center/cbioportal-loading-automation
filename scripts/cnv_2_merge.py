...
parser.add_argument(
    ...
    action="store",
    dest="info_dir",
    help="cnv info files available, provide here",
)
parser.add_argument(
    "-f",
    "--config",
...
# cnv_dir = args.converted_cnvs
cnv_dir = args.output + '/converted_cnvs/' 
# try:
#     os.makedirs(cnv_dir)
# except:
#     sys.stderr.write("cnv_dir dir already exists\n")
...
out_dir = args.output + "/merged_cnvs/"
try:
    os.makedirs(out_dir)
except:
